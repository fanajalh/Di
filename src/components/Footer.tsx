...
export default function Footer() {
  return (
    <footer className="bg-[#0A0A0A] border-t border-[#2A2A2A] pt-12 pb-8 text-[#949494] mt-20">
          ...
          <div className="md:col-span-4 space-y-3 text-xs text-left">
            ...
            <ul className="space-y-2.5">
              ...
              <li className="flex items-center gap-2 text-[#808080]">
                <Phone className="w-4 h-4 text-[#949494] shrink-0" />
                <span>+62 821-3456-7890</span>
              </li>
              <li className="flex items-center gap-2 text-[#808080]">
                <Mail className="w-4 h-4 text-[#949494] shrink-0" />
